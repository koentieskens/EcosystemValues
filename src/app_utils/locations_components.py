...
class LocationManager:
    ...
    def _activate_polygon(self):
        ...
        try:
            ...
            county, country, country_code, iso3 = St_Utils.get_location_info(ssm.PROJECT_LOCATION.get()['lat'],
    ...
    def location_info(self):
        ...
        if ssm.LOCATION_ACTIVATED.get():
            ...
            county, country, country_code, iso3 = St_Utils.get_location_info(ssm.PROJECT_LOCATION.get()['lat'], ssm.PROJECT_LOCATION.get()['lon'])
            ssm.SAVED_COUNTRY.set(country)
            ssm.SAVED_REGION.set(county)
            ssm.SAVED_COUNTRY_CODE.set(country_code)
            ssm.SAVED_COUNTRY_ISO3.set(iso3)
