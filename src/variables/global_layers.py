        ...
        for var in variables:
            if hasattr(var, 'name'):  # Only include your data objects
                row = {
                    ...
                    'data_unit': getattr(var, 'data_unit', None),
...
class GlobalVectorLayer:
    ...
    WB_ADMIN1_BOUNDARIES = GlobalVectorLayerData(
        ...
        gcs_path='/vsigs/nbs-tool-public/data/global_data/admin/WorldBankOfficialBoundariesAdmin1.gpkg',
        data_unit='n/a',
